...
/**
 *  TrackAnimal bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class TrackAnimal implements org.apache.axis2.databinding.ADBBean {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        namespace = "http://services.slaughterhouse.dk";
    ...
    public static class Factory {
         ...
         */
        public static TrackAnimal parse(javax.xml.stream.XMLStreamReader reader)
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"trackAnimal".equals(type)) {
                            ...
                            return (TrackAnimal) dk.slaughterhouse.services.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if ((reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://services.slaughterhouse.dk", "args0").equals(
                            reader.getName())) ||
