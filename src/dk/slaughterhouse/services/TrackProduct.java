...
/**
 *  TrackProduct bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class TrackProduct implements org.apache.axis2.databinding.ADBBean {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"trackProduct".equals(type)) {
                            ...
                            return (TrackProduct) dk.slaughterhouse.services.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
