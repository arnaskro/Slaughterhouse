...
/**
 *  GetAnimals bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class GetAnimals implements org.apache.axis2.databinding.ADBBean {
    ...
    public static class Factory {
         ...
         */
        public static GetAnimals parse(javax.xml.stream.XMLStreamReader reader)
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"getAnimals".equals(type)) {
                            ...
                            return (GetAnimals) dk.slaughterhouse.services.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
